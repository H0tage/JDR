...
const demoItems: CampaignInventoryItem[] = [
  { id: "demo-item-1", campaign_id: "demo", origin_loot_id: "demo-loot-1", parent_item_id: null, created_by: null, owner_user_id: null, owner_display_name: null, created_by_display_name: null, name: "Item anonymisé 1", quantity: 3, source_quantity_label: "3", unit_value_cp: 400, purchase_price_cp: null, aon_legacy_name: null, aon_legacy_url: null, source_kind: "loot", counts_as_gain: true, player_visible: true, status: "active", acquired_on: "2026-08-10", created_at: "2026-08-10T18:00:00Z", updated_at: "2026-08-10T18:00:00Z", pending_request_count: 0, requested_by_me: false },
  { id: "demo-item-2", campaign_id: "demo", origin_loot_id: "demo-loot-2", parent_item_id: null, created_by: null, owner_user_id: "demo-arsene", owner_display_name: "Prénom1 Nom1", created_by_display_name: null, name: "Item anonymisé 2", quantity: 1, source_quantity_label: "1", unit_value_cp: 3500, purchase_price_cp: null, aon_legacy_name: null, aon_legacy_url: null, source_kind: "loot", counts_as_gain: true, player_visible: true, status: "active", acquired_on: "2026-08-10", created_at: "2026-08-10T18:05:00Z", updated_at: "2026-08-10T18:05:00Z", pending_request_count: 1, requested_by_me: false },
  { id: "demo-item-3", campaign_id: "demo", origin_loot_id: null, parent_item_id: null, created_by: "demo-arsene", owner_user_id: "demo-morrigan", owner_display_name: "Prénom2 Nom2", created_by_display_name: "Prénom1 Nom1", name: "Item anonymisé 3", quantity: 2, source_quantity_label: "2", unit_value_cp: 1200, purchase_price_cp: 2400, aon_legacy_name: null, aon_legacy_url: null, source_kind: "purchase", counts_as_gain: false, player_visible: true, status: "active", acquired_on: "2026-08-12", created_at: "2026-08-12T18:00:00Z", updated_at: "2026-08-12T18:00:00Z", pending_request_count: 0, requested_by_me: false },
  { id: "demo-item-4", campaign_id: "demo", origin_loot_id: null, parent_item_id: null, created_by: null, owner_user_id: "demo-nox", owner_display_name: "Prénom4 Nom4", created_by_display_name: "Le Maître du Jeu", name: "Item anonymisé 4", quantity: 1, source_quantity_label: "1", unit_value_cp: 1800, purchase_price_cp: null, aon_legacy_name: null, aon_legacy_url: null, source_kind: "gm", counts_as_gain: true, player_visible: true, status: "active", acquired_on: "2026-08-14", created_at: "2026-08-14T18:00:00Z", updated_at: "2026-08-14T18:00:00Z", pending_request_count: 1, requested_by_me: true },
];
...
function demoEconomy(): PlayerEconomyData {
  return {
    ...
    items: demoItems,
    balances: [
      { campaign_id: "demo", account_user_id: null, display_name: "Compte commun", is_common: true, balance_cp: 12_850 },
    ...
    totals: { campaign_id: "demo", total_entered_cp: 42_750, total_exited_cp: 8_600, current_wealth_cp: 26_400 },
    money_history: [],
    item_history: [],
    requests: [
      { id: "demo-request-1", campaign_id: "demo", item_id: "demo-item-2", item_name: "Item anonymisé 2", requester_user_id: "demo-morrigan", requester_display_name: "Prénom2 Nom2", owner_user_id: "demo-arsene", owner_display_name: "Prénom1 Nom1", status: "pending", created_at: "2026-08-13T18:00:00Z", resolved_at: null },
      { id: "demo-request-2", campaign_id: "demo", item_id: "demo-item-4", item_name: "Item anonymisé 4", requester_user_id: "demo-arsene", requester_display_name: "Prénom1 Nom1", owner_user_id: "demo-nox", owner_display_name: "Prénom4 Nom4", status: "pending", created_at: "2026-08-14T19:00:00Z", resolved_at: null },
    ],
    debts: [],
  };
}
...
export async function loadPlayerEconomy(campaignId: string, demo = false): Promise<PlayerEconomyData> {
  ...
  return {
    ...
    totals: (totals.data ?? { campaign_id: campaignId, total_entered_cp: 0, total_exited_cp: 0, current_wealth_cp: 0 }) as CampaignEconomyTotals,
...
export const createManualInventoryItem = (input: { campaignId: string; name: string; quantity: number; unitValueCp?: number | null; ownerUserId?: string | null; aonName?: string; aonUrl?: string; comment?: string; countsAsGain?: boolean }) => rpc("create_manual_campaign_item", { p_campaign_id: input.campaignId, p_name: input.name, p_quantity: input.quantity, p_unit_value_cp: input.unitValueCp ?? null, p_owner_user_id: input.ownerUserId ?? null, p_aon_legacy_name: input.aonName || null, p_aon_legacy_url: input.aonUrl || null, p_comment: input.comment || null, p_counts_as_gain: input.countsAsGain ?? true }, "Création de l’objet");
