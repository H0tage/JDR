...
const factionSeeds = [
  ...
  ["exportation", "Guilde des Exportateurs", "Exportateurs", "#4c7d73", "Commerce extérieur et diplomatie", "Gestionnaires du commerce extérieur, des cargaisons et des partenaires étrangers."],
  ["réanimateurs", "Réanimateurs", "Réanimateurs", "#7a5d93", "Nécromancie, agriculture et main-d’œuvre", "Nécromanciens responsables de la production agricole et du travail mort-vivant."],
  ["uci", "Syndicats des Percepteurs d’Impôts", "Percepteurs", "#b18335", "Finance, fiscalité et contrats", "Aristocrates, banquiers et percepteurs qui transforment la richesse en influence."],
  ["charretiers", "Consortium des Convoyeurs", "Convoyeurs", "#65717c", "Transport intérieur et logistique", "Ancienne grande faction déchue, toujours indispensable aux routes et aux convois."],
] as const;
...
const dossierRows = [
  ...
  ["bâtisseurs", "uci", "Bâtisseurs ↔ Percepteurs", "Les SPI nomment la Ligue alliée ; tradition, caveaux et structures impénétrables.", "La Ligue conçoit, autorise et garde les secrets techniques.", "Les SPI financent, possèdent, taxent et saisissent.", "Banques, coffres, immobilier, péages et reconstruction.", "Propriété du projet, copie des plans et dépassement de coût.", "Défaut ; audit ; titre ancien ; plan copié ; permis lié à un prêt.", "Deux contrats concurrents rouvrent une banque : propriété aux SPI ou contrôle technique à la Ligue.", "Alliance explicite côté SPI."],
  ["bâtisseurs", "charretiers", "Bâtisseurs ↔ Convoyeurs", "Routes et relais bâtis par la Ligue ; transport intérieur assuré par le Consortium.", "La Ligue traite facilement la faction déchue comme exécutant remplaçable.", "Les Convoyeurs vivent chaque route abandonnée comme le mépris des Grandes Factions.", "Ponts, relais, convois, réparations et déviations.", "Priorité des travaux, sécurité, péages et responsabilité.", "Pont fermé ; route vendue ; relais réquisitionné ; village oublié.", "Rouvrir la route de Pakged : permis complet ou réparation illégale avant la nuit.", "Synthèse des domaines ; ressentiment optionnel."],
  ["célébrants", "exportation", "Célébrants ↔ Exportateurs", "Partenariat officiel de vitrine ; la Guilde nomme les Célébrants alliés.", "Les Célébrants contrôlent le récit, la cérémonie et la visibilité.", "La Guilde contrôle invités, cargaisons et coût diplomatique.", "Délégations, cérémonies portuaires, captifs informés et promotion nationale.", "Spectacle contre discrétion et pragmatisme marchand.", "Invité offensé ; captif disputé ; cargaison indigne ; vérité gênante.", "Accueillir un émissaire : accord discret ou procession qui expose tout.", "Alliance explicite et arrangement fonctionnel."],
...
export const mockJournal: JournalEntry[] = [{
  ...
  details: "Berline Haldoli fait connaître l’efficacité du groupe auprès des Réanimateurs.",
  rp_delta: 5,
  jf_delta: 5,
  tension_delta: 0,
  visibility: "players",
